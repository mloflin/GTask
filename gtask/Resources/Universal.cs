...
//if (DateTime.TryParse(oldDate, currentCulture, DateTimeStyles.None, out result))
//{

//}
//else
//{
//do nothing as formatting matches already
//}

//test
//string test = "27/07/2015 02:21:19";
//if (!DateTime.TryParseExact(test, newDTF.ShortDatePattern.ToString(), currentCulture, DateTimeStyles.None, out result))
//{
//}
//if (!DateTime.TryParse(test, currentCulture, DateTimeStyles.None, out result))
//{
//}

//string test2 = "07/27/2015 02:21:19";
//if (!DateTime.TryParseExact(test2, newDTF.ShortDatePattern.ToString(), currentCulture, DateTimeStyles.None, out result))
//{
//}

//if (!DateTime.TryParse(test2, currentCulture, DateTimeStyles.None, out result))
//{
//}
...
//try
//{
//    newDate = Convert.ToDateTime(oldDate, usDTF).ToString(newDTF.ShortDatePattern) + right9;
//}
//    catch (Exception)
//{
//    return newDate;
